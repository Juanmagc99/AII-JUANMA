...
class Partido(models.Model):
    ...
    local = models.ForeignKey(Equipo, related_name='jornada_local', on_delete=models.CASCADE)
    visitante = models.ForeignKey(Equipo,related_name='jornada_visitante', on_delete=models.CASCADE)
